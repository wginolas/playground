...
-- P02 (*) Find the last but one box of a list.  Example: * (my-but-last
--     '(a b c d)) (C D)
...
-- P03 (*) Find the K'th element of a list.  The first element in the
--     list is number 1.  Example: * (element-at '(a b c d e) 3) C
...
--     numbers.  Use Euclid's algorithm.  Example: * (gcd 36 63) 9
--
-- P33 (*) Determine whether two positive integer numbers are coprime.
--     Two numbers are coprime if their greatest common divisor equals 1.
--     Example: * (coprime 35 64) T
--
-- P34 (**) Calculate Euler's totient function phi(m).  Euler's so-called
--     totient function phi(m) is defined as the number of positive
...
--     order.  Example: * (prime-factors 315) (3 3 5 7)
--
-- P36 (**) Determine the prime factors of a given positive integer (2).
--     Construct a list containing the prime factors and their
--     multiplicity.  Example: * (prime-factors-mult 315) ((3 2) (5 1) (7
--     1))
--
--     Hint: The problem is similar to problem P13.
--
-- P37 (**) Calculate Euler's totient function phi(m) (improved).  See
--     problem P34 for the definition of Euler's totient function. If the
...
--     the algorithms. Take the number of logical inferences as a measure
...
--     that range.
--
-- P40 (**) Goldbach's conjecture.  Goldbach's conjecture says that every
--     positive even number greater than 2 is the sum of two prime
--     numbers. Example: 28 = 5 + 23. It is one of the most famous facts
--     in number theory that has not been proved to be correct in the
--     general case. It has been numerically confirmed up to very large
--     numbers (much larger than we can go with our Prolog system). Write
--     a predicate to find the two prime numbers that sum up to a given
--     even integer.
--
--     Example: * (goldbach 28) (5 23)
--
-- P41 (**) A list of Goldbach compositions.  Given a range of integers
--     by its lower and upper limit, print a list of all even numbers and
--     their Goldbach composition.
--
--     Example: * (goldbach-list 9 20) 10 = 3 + 7 12 = 5 + 7 14 = 3 + 11
...
--
--     Example (for a print limit of 50): * (goldbach-list 1 2000 50) 992
--     = 73 + 919 1382 = 61 + 1321 1856 = 67 + 1789 1928 = 61 + 1867
--
-- Logic and Codes
--
-- P46 (**) Truth tables for logical expressions.  Define predicates
--     and/2, or/2, nand/2, nor/2, xor/2, impl/2 and equ/2 (for logical
--     equivalence) which succeed or fail according to the result of
--     their respective operations; e.g. and(A,B) will succeed, if and
--     only if both A and B succeed. Note that A and B can be Prolog
...
--
--     Example: * table([A,B,C], A and (B or C) equ A and B or A and C).
...
-- two successors, which are binary trees themselves.  In Lisp we
-- represent the empty tree by 'nil' and the non-empty tree by the list
-- (X L R), where X denotes the root node and L and R denote the left and
-- right subtree, respectively. The example tree depicted opposite is
-- therefore represented by the following list:
--
...
--
-- P54A (*) Check whether a given term represents a binary tree Write a
--     predicate istree which returns true if and only if its argument is
--     a list representing a binary tree.  Example: * (istree (a (b nil
--     nil) nil)) T * (istree (a (b nil nil))) NIL
--
...
--     into all nodes of the tree.  Example: * cbal-tree(4,T).  T = t(x,
--     t(x, nil, nil), t(x, nil, t(x, nil, nil))) ; T = t(x, t(x, nil,
--     nil), t(x, t(x, nil, nil), nil)) ; etc......No
--
-- P56 (**) Symmetric binary trees Let us call a binary tree symmetric if
--     you can draw a vertical line through the root node and then the
--     right subtree is the mirror image of the left subtree. Write a
--     predicate symmetric/1 to check whether a given binary tree is
...
--
-- P57 (**) Binary search trees (dictionaries) Use the predicate add/3,
--     developed in chapter 4 of the course, to write a predicate to
--     construct a binary search tree from a list of integer numbers.
--     Example: * construct([3,2,5,7,1],T).  T = t(3, t(2, t(1, nil,
--     nil), nil), t(5, nil, t(7, nil, nil)))
--
--     Then use this predicate to test the solution of the problem P56.
--     Example: * test-symmetric([5,3,18,1,4,12,21]).  Yes *
--     test-symmetric([3,2,5,7,1]).  No
--
-- P58 (**) Generate-and-test paradigm Apply the generate-and-test
--     paradigm to construct all symmetric, completely balanced binary
--     trees with a given number of nodes. Example: *
--     sym-cbal-trees(5,Ts).  Ts = [t(x, t(x, nil, t(x, nil, nil)), t(x,
--     t(x, nil, nil), nil)), t(x, t(x, t(x, nil, nil), nil), t(x, nil,
--     t(x, nil, nil)))]
--
...
--
-- P59 (**) Construct height-balanced binary trees In a height-balanced
--     binary tree, the following property holds for every node: The
--     height of its left subtree and the height of its right subtree are
--     almost equal, which means their difference is not greater than
--     one.
--
...
--     all nodes of the tree.  Example: * hbal-tree(3,T).  T = t(x, t(x,
--     t(x, nil, nil), t(x, nil, nil)), t(x, t(x, nil, nil), t(x, nil,
--     nil))) ; T = t(x, t(x, t(x, nil, nil), t(x, nil, nil)), t(x, t(x,
--     nil, nil), nil)) ; etc......No
--
-- P60 (**) Construct height-balanced binary trees with a given number of
--     nodes Consider a height-balanced binary tree of height H. What is
--     the maximum number of nodes it can contain?  Clearly, MaxN = 2**H
...
--     a predicate minNodes/2 defined as follwos:
--
--     % minNodes(H,N) :- N is the minimum number of nodes in a
--     height-balanced binary tree of height H.  (integer,integer), (+,?)
--
...
--     binary tree with N nodes (integer,integer), (+,?)
--
...
--
-- P61 (*) Count the leaves of a binary tree A leaf is a node with no
--     successors. Write a predicate count-leaves/2 to count them.
--
--     % count-leaves(T,N) :- the binary tree T has N leaves
--
-- P61A (*) Collect the leaves of a binary tree in a list A leaf is a
--     node with no successors. Write a predicate leaves/2 to collect
--     them in a list.
--
--     % leaves(T,S) :- S is the list of all leaves of the binary tree T
--
-- P62 (*) Collect the internal nodes of a binary tree in a list An
--     internal node of a binary tree has either one or two non-empty
...
--       tree T.
--
-- P62B (*) Collect the nodes at a given level in a list A node of a
--     binary tree is at level N if the path from the root to the node
--     has length N-1. The root node is at level 1. Write a predicate
...
--
-- P63 (**) Construct a complete binary tree A complete binary tree with
--     height H is defined as follows: The levels 1,2,3,...,H-1 contain
--     the maximum number of nodes (i.e 2**(i-1) at the level i, note
--     that we start counting the levels from 1 at the root). In level H,
--     which may contain less than the maximum possible number of nodes,
--     all the nodes are "left-adjusted". This means that in a levelorder
--     tree traversal all internal nodes come first, the leaves come
--     second, and empty successors (the nil's which are not really
--     nodes!) come last.
--
...
--
-- P64 (**) Layout a binary tree (1) Given a binary tree as the usual
--     Prolog term t(X,L,R) (or nil). As a preparation for drawing the
--     tree, a layout algorithm is required to determine the position of
--     each node in a rectangular grid. Several layout methods are
...
--
--     % nil represents the empty tree (as usual) t(W,X,Y,L,R) represents
...
--     Test your predicate in an appropriate way.
--
-- P65 (**) Layout a binary tree (2) An alternative layout method is
--     depicted in the illustration opposite. Find out the rules and
...
--
-- P66 (***) Layout a binary tree (3) Yet another layout strategy is
--     shown in the illustration opposite. The method yields a very
--     compact layout while maintaining a certain symmetry in every
--     node. Find out the rules and write the corresponding Prolog
--     predicate. Hint: Consider the horizontal distance between a node
--     and its successor nodes. How tight can you pack together two
...
--
-- P68 (**) Preorder and inorder sequences of binary trees We consider
--     binary trees with nodes that are identified by single lower-case
...
--
-- P69 (**) Dotstring representation of binary trees We consider again
--     binary trees with nodes that are identified by single lower-case
--     letters, as in the example of problem P67. Such a tree can be
--     represented by the preorder sequence of its nodes in which dots
--     (.) are inserted where an empty subtree (nil) is encountered
--     during the tree traversal. For example, the tree shown in problem
--     P67 is represented as 'abd..e..c.fg...'. First, try to establish a
--     syntax (BNF or syntax diagrams) and then write a predicate
--     tree-dotstring/2 which does the conversion in both directions. Use
--     difference lists.
--
-- Multiway Trees A multiway tree is composed of a root element and a
-- (possibly empty) set of successors which are multiway trees
-- themselves. A multiway tree is never empty. The set of successor trees
...
--
--
-- P70B (*) Check whether a given term represents a multiway tree Write a
--     predicate istree/1 which succeeds if and only if its argument is a
--     Prolog term representing a multiway tree.  Example: *
--     istree(t(a,[t(f,[t(g,[])]),t(c,[]),t(b,[t(d,[]),t(e,[])])])).  Yes
--
-- P70C (*) Count the nodes of a multiway tree Write a predicate nnodes/1
--     which counts the nodes of a given multiway tree.  Example: *
--     nnodes(t(a,[t(f,[])]),N).  N = 2
--
--     Write another version of the predicate that allows for a flow
--     pattern (o,i).
--
-- P70 (**) Tree construction from a node string We suppose that the
--     nodes of a multiway tree contain single characters. In the
--     depth-first order sequence of its nodes, a special character ^ has
...
--
-- P71 (*) Determine the internal path length of a tree We define the
--     internal path length of a multiway tree as the total sum of the
--     path lengths from the root to all nodes of the tree. By this
--     definition, the tree in the figure of problem P70 has an internal
--     path length of 9. Write a predicate ipl(Tree,IPL) for the flow
--     pattern (+,-).
--
-- P72 (*) Construct the bottom-up order sequence of the tree nodes Write
--     a predicate bottom-up(Tree,Seq) which constructs the bottom-up
...
--
-- P73 (**) Lisp-like tree representation There is a particular notation
--     for multiway trees in Lisp. Lisp is a prominent functional
--     programming language, which is used primarily for artificial
--     intelligence problems. As such it is one of the main competitors
...
--     tree is a sequence of atoms and parentheses '(' and ')', which we
--     shall collectively call "tokens". We can represent this sequence
--     of tokens as a Prolog list; e.g. the lispy expression (a (b c))
--     could be represented as the Prolog list ['(', a, '(', b, c, ')',
--     ')']. Write a predicate tree-ltl(T,LTL) which constructs the
--     "lispy token list" LTL if the tree is given as term T in the usual
--     Prolog notation.
--
--     Example: * tree-ltl(t(a,[t(b,[]),t(c,[])]),LTL).  LTL = ['(', a,
--     '(', b, c, ')', ')']
--
...
--     lists.
--
-- Graphs A graph is defined as a set of nodes and a set of edges, where
...
--
-- Adjacency-list form [n(k,[]),n(m,[q/7]),n(p,[m/5,q/9]),n(q,[])] Notice
--     how the edge information has been packed into a term with functor
...
-- two given nodes.
--
-- P80 (***) Conversions Write predicates to convert between the
--     different graph representations. With these predicates, all
--     representations are equivalent; i.e. for the following problems
--     you can always pick freely the most convenient form. The reason
--     this problem is rated (***) is not because it's particularly
--     difficult, but because it's a lot of work to deal with all the
--     special cases.
--
-- P81 (**) Path from one node to another one Write a predicate
--     path(G,A,B,P) to find an acyclic path P from node A to node b in
--     the graph G. The predicate should return all paths via
--     backtracking.
--
-- P82 (*) Cycle from a given node Write a predicate cycle(G,A,P) to find
--     a closed path (cycle) P starting at a given node A in the graph
--     G. The predicate should return all cycles via backtracking.
--
-- P83 (**) Construct all spanning trees Write a predicate
--     s-tree(Graph,Tree) to construct (by backtracking) all spanning
--     trees of a given graph. With this predicate, find out how many
--     spanning trees there are for the graph depicted to the left. The
--     data of this example graph can be found in the file p83.dat. When
--     you have a correct solution for the s-tree/2 predicate, use it to
--     define two other useful predicates: is-tree(Graph) and
--     is-connected(Graph). Both are five-minutes tasks!
--
-- P84 (**) Construct the minimal spanning tree Write a predicate
--     ms-tree(Graph,Tree,Sum) to construct the minimal spanning tree of
--     a given labelled graph. Hint: Use the algorithm of Prim. A small
...
--
--
-- P85 (**) Graph isomorphism Two graphs G1(N1,E1) and G2(N2,E2) are
--     isomorphic if there is a bijection f: N1 -> N2 such that for any
--     nodes X,Y of N1, X and Y are adjacent if and only if f(X) and f(Y)
--     are adjacent.
--
...
--     f.
--
-- P86 (**) Node degree and graph coloration a) Write a predicate
--     degree(Graph,Node,Deg) that determines the degree of a given node.
--
...
--
-- P88 (**) Connected components (alternative solution) Write a predicate
--     that splits a graph into its connected components.
--
-- P89 (**) Bipartite graphs Write a predicate that finds out whether a
--     given graph is bipartite.
--
--
-- Miscellaneous Problems
--
-- P90 (**) Eight queens problem This is a classical problem in computer
--     science. The objective is to place eight queens on a chessboard so
--     that no two queens are attacking each other; i.e., no two queens
...
--
-- P91 (**) Knight's tour Another famous problem is this one: How can a
--     knight jump on an NxN chessboard in such a way that it visits
...
--     relation jump(N,X/Y,U/V) to express the fact that a knight can
--     jump from X/Y to U/V on a NxN chessboard. And finally, represent
--     the solution of our problem as a list of N*N knight positions (the
--     knight's tour).
--
-- P92 (***) Von Koch's conjecture Several years ago I met a
--     mathematician who was intrigued by a problem for which he didn't
--     know a solution. His name was Von Koch, and I don't know whether
...
--
-- P93 (***) An arithmetic puzzle Given a list of integer numbers, find a
--     correct way of inserting arithmetic signs (operators) such that
--     the result is a correct equation. Example: With the list of
--     numbers [2,3,5,7,11] we can form the equations 2-3+5+7 = 11 or 2 =
--     (3*5+7)/11 (and ten others!).
--
-- P94 (***) Generate K-regular simple graphs with N nodes In a K-regular
--     graph all nodes have a degree of K; i.e. the number of edges
--     incident in each node is K. How many (non-isomorphic!) 3-regular
--     graphs with 6 nodes are there? See also a table of results and a
--     Java applet that can represent graphs geometrically.
--
-- P95 (**) English number words On financial documents, like cheques,
--     numbers must sometimes be written in full words. Example: 175 must
--     be written as one-seven-five. Write a predicate full-words/1 to
...
--
--     % identifier(Str) :- Str is a legal identifier P97 (**) Sudoku
-- Sudoku puzzles go like this:
--
--        Problem statement Solution
--
--         .  .  4 | 8 .  . | .  1 7 9 3 4 | 8 2 5 | 6 1 7 | | | | 6 7
--         . | 9 .  . | .  .  .  6 7 2 | 9 1 4 | 8 5 3 | | | | 5 .  8 | .
--         3 . | .  .  4 5 1 8 | 6 3 7 | 9 2 4
--         --------+---------+-------- --------+---------+-------- 3 .
--         . | 7 4 . | 1 .  .  3 2 5 | 7 4 8 | 1 6 9 | | | | .  6 9 | .
--         .  . | 7 8 .  4 6 9 | 1 5 3 | 7 8 2 | | | | .  .  1 | .  6 9 |
--         .  .  5 7 8 1 | 2 6 9 | 4 3 5 --------+---------+--------
--         --------+---------+-------- 1 .  . | .  8 . | 3 .  6 1 9 7 | 5
--         8 2 | 3 4 6 | | | | .  .  . | .  .  6 | .  9 1 8 5 3 | 4 7 6 |
--         2 9 1 | | | | 2 4 . | .  .  1 | 5 .  .  2 4 6 | 3 9 1 | 5 7 8
--
--
...
-- square.  P98 (***) Nonograms Around 1994, a certain kind of puzzles
-- was very popular in England. The "Sunday Telegraph" newspaper wrote:
-- "Nonograms are puzzles from Japan and are currently published each
-- week only in The Sunday Telegraph. Simply use your logic and skill to
-- complete the grid and reveal a picture or diagram." As a Prolog
-- programmer, you are in a better situation: you can have your computer
...
--               Problem statement: Solution:
--
--               |_|_|_|_|_|_|_|_| 3 |_|X|X|X|_|_|_|_| 3 _|_|_|_|_|_|_|_|
--               |2 1 |X|X|_|X|_|_|_|_| 2 1 _|_|_|_|_|_|_|_| 3 2
--               ||_|X|X|X|_|_|X|X| 3 2 _|_|_|_|_|_|_|_| 2 2
--               ||_|_|X|X|_|_|X|X| 2 2 _|_|_|_|_|_|_|_| 6
--               ||_|_|X|X|X|X|X|X| 6 _|_|_|_|_|_|_|_| 1 5
--               ||X|_|X|X|X|X|X|_| 1 5 _|_|_|_|_|_|_|_| 6
--               ||X|X|X|X|X|X|_|_| 6 _|_|_|_|_|_|_|_| 1
--               ||_|_|_|_|X|_|_|_| 1 _|_|_|_|_|_|_|_| 2
--               ||_|_|_|X|X|_|_|_| 2 1 3 1 7 5 3 4 3 1 3 1 7 5 3 4 3 2 1
--               |5 1 2 1 5 1
--
--
...
--
-- P99 (***) Crossword puzzle Given an empty (or almost empty) framework
--     of a crossword puzzle and a set of words. The problem is to place
...
--     p99a.dat, other examples are p99b.dat and p99d.dat. There is also
...
--     quick-and-dirty hack!  (2) Reading the data file is a tricky
--     problem for which a solution is provided in the file
--     p99-readfile.lisp. Use the predicate read_lines/2.  (3) For
--     efficiency reasons it is important, at least for larger puzzles,
--     to sort the words and the sites in a particular order. For this
--     part of the problem, the solution of P28 may be very helpful.
